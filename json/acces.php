...
$resjor = mysql_query("SELECT jornada from puntuaciones WHERE temporada = '2013/2014' order by jornada desc limit 1");
...
if ($num_rows > 0) {
	...
	$resultado[]=array("logstatus"=>"1","movil_id"=>$row['movil_id'],"ult_jornada"=>$jornada);
	...
	$resultado[]=array("logstatus"=>"0","movil_id"=>"","ult_jornada"=>$jornada);
