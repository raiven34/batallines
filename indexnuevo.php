...
include('conexion.php');
           ...
           print('<br />');
			   ...
			   if ($resultado['imagen']!= NULL) {
	          	...
	          	<div class="noticias"><br /><img class="fotonoticia" src=' . "'" . $resultado['imagen'] . "'" . '/><div class="divtexto">' . $resultado['texto'] . '</div><a href="leernoticia.php?comienzo=' . $noticia . '">Leer noticia completa</a>' . '<br /><br />' . '</div>
	           	<div class="fondonoticiasi">Escrito por: ' . $resultado['autor'] . ' el ' . $resultado['fecha'] . '</div>');
			   }
			   else{
			   	print('<div class="fondonoticiass">' . $resultado['titulo'] . '
	           	</div>
	          	<div class="noticias"><br /><img class="fotonoticia" src=' . "'img/Escudo.jpg'" . '/><div class="divtexto">' . $resultado['texto'] . '</div><a href="leernoticia.php?comienzo=' . $noticia . '">Leer noticia completa</a>' . '<br /><br /></iframe>' . '</div>
	           	<div class="fondonoticiasi">Escrito por: ' . $resultado['autor'] . ' el ' . $resultado['fecha'] . '</div>');
			   }
