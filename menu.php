      <div id="menu">
                    <ul>
                      ...
                      <li id="clasificacion" class="nivel1"><a href="http://gestdeportes.lasrozas.es/CampeonatosWeb/index1.aspx" target="_blank">Clasificación</a></li>
                      <li id="videos" class="nivel1"><a href="videos.php">Videos</a></li>
                      <li id="videos" class="nivel1"><a href="/batallines_app/Batallines.apk">Aplicación Android</a></li>
                      <li id="admin" class="nivel1"><a href="http://batallines.es/adminbatallines.php" target="_blank">Admin</a></li>
                    </ul>
                    <div id="login"></div>  
      </div> 