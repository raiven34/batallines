...
<?php require_once '../../librerias/header.php';?>
        ...
        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12 marginbotlow fondovideosfotosma">
                <img class="col-xs-12 col-lg-12 col-md-12 col-sm-12"  src="../../img/MA_Logo_spanishWEB.png" />
                ...
                <iframe class="destacado sinpadding img-rounded marginbotlow col-xs-6 col-lg-6 col-md-6 col-sm-6 col-xs-offset-3 col-lg-offset-3 col-md-offset-3 col-sm-offset-3 videosma" src="https://www.youtube.com/embed/oDU6_3Grv64" frameborder="0" allowfullscreen></iframe>
                <iframe class="destacado sinpadding img-rounded marginbotlow col-xs-6 col-lg-6 col-md-6 col-sm-6 col-xs-offset-3 col-lg-offset-3 col-md-offset-3 col-sm-offset-3 videosma" src="https://www.youtube.com/embed/ElcqhyRKq80" frameborder="0" allowfullscreen></iframe>
