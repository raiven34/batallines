...
<!--            <div class="item"><div class="itemcarousel fondoblanco">
          ...
          <!-- Carousel nav -->
          <a class="carousel-control left navlateral"  href="#myCarousel" data-slide="prev">&lsaquo;</a>
          <a class="carousel-control right navlateral"  href="#myCarousel" data-slide="next">&rsaquo;</a>
        </div>
