...
if ( !headers_sent() ) {
	...
	$dia_fin = date('d-m-Y', $dia); //Formatea dia
        $ruta="/home/a4020657/public_html/backup/semanal_" . $info['fecha'] . ".gz";
        $rutab="/home/a4020657/public_html/backup/semanal_" . $dia_fin . ".gz";
        if (!is_file($ruta)){
        	
        	$br=fopen($ruta,"w") or die("Problemas en la creacion");
    		fputs($br,gzencode($dump,9));
    		fclose($br);
 //   		unlink($rutab);
    	}
